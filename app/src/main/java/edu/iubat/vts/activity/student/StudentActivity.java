package edu.iubat.vts.activity.student;
...
import edu.iubat.vts.databinding.ActivityStudentBinding;
...
public class StudentActivity extends AppCompatActivity implements NavController.OnDestinationChangedListener,
        NavigationView.OnNavigationItemSelectedListener {
    private static final String LOG_TAG = StudentActivity.class.getSimpleName();

    private ActivityStudentBinding viewBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBinding = ActivityStudentBinding.inflate(getLayoutInflater());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_sign_out) {
            ...
            navController.navigate(R.id.nav_student_profile);
        }
        return false;
    }
