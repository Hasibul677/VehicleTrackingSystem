package edu.iubat.vts.activity.driver;
...
import edu.iubat.vts.databinding.ActivityDriverBinding;
...
public class DriverActivity extends AppCompatActivity implements NavController.OnDestinationChangedListener,
        NavigationView.OnNavigationItemSelectedListener {
    private static final String LOG_TAG = DriverActivity.class.getSimpleName();

    private ActivityDriverBinding viewBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBinding = ActivityDriverBinding.inflate(getLayoutInflater());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_sign_out) {
            ...
            navController.navigate(R.id.nav_driver_profile);
        }
        return false;
    }
